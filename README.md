### Edits
 ...
 - Added log file in /var/artillery/logs/honeypot.log

 - Added to reporting features:
   - Automatic location info based on IP address (using ipinfo.io API)
   - Send emails only after "x" IP hits
   - Daily summary feature emails top ten hits of the day
